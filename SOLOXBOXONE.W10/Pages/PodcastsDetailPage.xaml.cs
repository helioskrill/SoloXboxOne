//---------------------------------------------------------------------------
//
// <copyright file="PodcastsDetailPage.xaml.cs" company="Microsoft">
...
{
    public sealed partial class PodcastsDetailPage : Page
    {
        private DataTransferManager _dataTransferManager;

        public PodcastsDetailPage()
        {
            this.ViewModel = DetailViewModel.CreateNew(Singleton<PodcastsConfig>.Instance);
