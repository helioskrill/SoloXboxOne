//---------------------------------------------------------------------------
//
// <copyright file="ArticulosDetailPage.xaml.cs" company="Microsoft">
...
{
    public sealed partial class ArticulosDetailPage : Page
    {
        private DataTransferManager _dataTransferManager;

        public ArticulosDetailPage()
        {
            this.ViewModel = DetailViewModel.CreateNew(Singleton<ArticulosConfig>.Instance);
