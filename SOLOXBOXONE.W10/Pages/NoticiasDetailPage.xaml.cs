//---------------------------------------------------------------------------
//
// <copyright file="NoticiasDetailPage.xaml.cs" company="Microsoft">
...
{
    public sealed partial class NoticiasDetailPage : Page
    {
        private DataTransferManager _dataTransferManager;

        public NoticiasDetailPage()
        {
            this.ViewModel = DetailViewModel.CreateNew(Singleton<NoticiasConfig>.Instance);
