//---------------------------------------------------------------------------
//
// <copyright file="Windows10DetailPage.xaml.cs" company="Microsoft">
...
{
    public sealed partial class Windows10DetailPage : Page
    {
        private DataTransferManager _dataTransferManager;

        public Windows10DetailPage()
        {
            this.ViewModel = DetailViewModel.CreateNew(Singleton<Windows10Config>.Instance);
