...
{
    public class Windows10Config : SectionConfigBase<RssSchema>
    {
		public override Func<Task<IEnumerable<RssSchema>>> LoadDataAsyncFunc
        {
            get
            {
                ...
                {
                    Url = new Uri("http://soloxboxone.com/category/windows-10/feed/")
                };
        ...
        public override ListPageConfig<RssSchema> ListPage
        {
            get 
            {
                return new ListPageConfig<RssSchema>
                {
                    ...
                    ListNavigationInfo = NavigationInfo.FromPage("Windows10ListPage"),
                    ...
                    {
                        return NavigationInfo.FromPage("Windows10DetailPage", true);
                    }
                };
            }
        }
