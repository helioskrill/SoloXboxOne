...
{
    public class Foro20Config : SectionConfigBase<RssSchema>
    {
		public override Func<Task<IEnumerable<RssSchema>>> LoadDataAsyncFunc
        {
            get
            {
                ...
                {
                    Url = new Uri("http://soloxboxone.com/foro/feed/")
                };
        ...
        public override ListPageConfig<RssSchema> ListPage
        {
            get 
            {
                return new ListPageConfig<RssSchema>
                {
                    ...
                    ListNavigationInfo = NavigationInfo.FromPage("Foro20ListPage"),
                    ...
                    {
                        return NavigationInfo.FromPage("Foro20DetailPage", true);
                    }
                };
            }
        }
